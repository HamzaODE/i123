...
const StepFifteen = ({ routeHandler }) => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    if (skydivingFFJAffliatedClub === 'Yes') {
      routeHandler("/personal/life?question=16");
  } else if (skydivingFFJAffliatedClub === 'No') {
  ...
  return (
    <div className="text-Left text-[30px] font-light text-black">
      ...
      <p className="text-center">Are you affiliated with a club?</p>
